This folder contains DELTA-Pro libaries. These files are used by KICAD in circuit board layouts. 

As of Jan 2019 KiCad 4.0.7 is the offical KICAD for DELTA-Pro's layouts. 

Please note that you would need to fork https://github.com/DELTA-Pro/kicad-libraries if
you would like to contribute to DELTA-Pro component library - you cannot contribute to
this using https://github.com/DELTA-Pro/DELTA-Pro or other repositories
